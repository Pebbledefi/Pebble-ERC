...
=== 'Pebble' Token contract with following features ===
    => BEP20 Compliance
    => Safeguard functionality
    => SafeMath implementation 
    => Burnable 
    => user whitelisting 
    => user wallet blacklisting/freezing to prevent system abuse 


======================= Quick Stats ===================
    => Name        : Pebble
    => Symbol      : PEBBLE
    => Total supply: 2,000,000 (2 Million)
    => Decimals    : 18
...
-------------------------------------------------------------------
 ...
 Copyright (c) 2021 Pebble Defi ( https://pebbledefi.org )
-------------------------------------------------------------------
*/ 
...
contract Pebble is owned {
    ...
    string constant private _name = "Pebble";
    string constant private _symbol = "PEBBLE";
